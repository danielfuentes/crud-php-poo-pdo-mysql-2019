            ...
            <!--Aquí colocar los errores tal como se mostraron en el programa de agragarPelicula.php-->
                <form action="" method="post" enctype="multipart/formdata">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" id="nombrePelicula" value="<?= $movie[0]['title']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="ratingPelicula">Rating</label>
                        <input type="number" class="form-control" name="rating" id="ratingPelicula" value="<?= $movie[0]['rating']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="awards">Awards</label>
                        <input type="number" class="form-control" name="awards" id="awards" value="<?= $movie[0]['awards']; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="length" id="duracionPelicula" value="<?= $movie[0]['length']; ?>">
                    </div>
                    <div class="form-group">
                        <label for="generos">Género de la Película</label>
                        <select class="form-control" name="genre_id" id="generos">
                          <option value="<?= $movie[0]['genre_id']; ?>"><?= $movie[0]['name']; ?></option>
                          <?php foreach($genres as $genre): ?>
					                  <?php if($genre['id']!=$movie[0]['genre_id']): ?>
